...
def banner():
    ...
    print " "
    time.sleep(1.5)
    print GG+"_____ __      _____  _______ ______  _______"
    print W +"  |   | \  | |  ____ |______ |_____] |______"
    print GG+"__|__ |  \_| |_____| ______| |_____] |"
    
banner()

print wd+"            SEMOGA BERHASIL "
         ...
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              `-/+///..````..://+/-`
                ...
                \033[90;1YOUR FUTURE HACKER\033[91;1m
             Powered by:\033[97m BLACK - CYBER -TEAM
      """
         ...
         print wd+" [#] RUNNING Password ATTEMPT\033[97;1m:", len(nuub),'password'
         print wd+" [#] CRACKING PASSWORD\033[97;1m.........."
         print " "
